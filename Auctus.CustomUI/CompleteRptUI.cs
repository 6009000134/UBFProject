...
{
    public class CompleteRptUI : UFSoft.UBF.UI.Custom.ExtendedPartBase
    {
...
a.DescFlexField_PrivateDescSeg2 OAFlowID,b.DescFlexField_PrivateDescSeg1 IsToOA,a.DocState
FROM dbo.mo_completerpt a INNER JOIN dbo.MO_CompleteRptDocType b ON a.CompleteDocType=b.ID WHERE a.ID={0}", rec["ID"].ToString());
