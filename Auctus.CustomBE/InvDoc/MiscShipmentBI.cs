...
namespace Auctus.CustomBE.InvDoc
{
    public class MiscShipmentBI : UFSoft.UBF.Eventing.IEventSubscriber
    {
        public void Notify(params object[] args)
        {
            ...
            UFIDA.U9.InvDoc.MiscShip.MiscShipment entity = (UFIDA.U9.InvDoc.MiscShip.MiscShipment)key.GetEntity();
            if (entity == null)
            {
                return;
            }
